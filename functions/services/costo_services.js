	...
	costo_app.factory('costo_services', ['$http', '$q','$cookies',
		function($http, $q, $cookies) {
			...
			function http_call(options){
				...
				// var bearer_token = 'QOgV8JGlBR5ZpMf75dM5ScC9uPZw6DDp';

				//Local RAZ machine config
				// var domain = 'http://localhost/raz/listify/wp-json';
				// var json_params = {
				// 	consumer_key:'ck_0297bee89940b8b22757944ba5ff8f3ee00ba4cb',
				// 	consumer_secret:'cs_2ab2dc47d37af267ea23bf493fd96fed2fabbddd'
